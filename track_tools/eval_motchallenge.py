...
string.""", formatter_class=argparse.RawTextHelpFormatter)
    ...
    parser.add_argument('--groundtruths', type=str,default='../mot/train',help='Directory containing ground truth files.')
    parser.add_argument('--tests', type=str,default='val/tracks', help='Directory containing tracker result files')
    parser.add_argument('--score_threshold', type=float, help='Score threshold',default=-1)
    parser.add_argument('--gt_type', type=str, default='_val_half')
