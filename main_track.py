...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='mot', type=str)
    parser.add_argument('--coco_panoptic_path', type=str, default='mot')
    parser.add_argument('--remove_difficult', action='store_true')

    parser.add_argument('--output_dir', default='../output_crowdhuman',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default=0,
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='619mot17_mot17.pth', help='resume from checkpoint')
    ...
    # appended for track.
    parser.add_argument('--track_train_split', default='trainall', type=str)
